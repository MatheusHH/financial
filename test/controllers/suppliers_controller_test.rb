...
class SuppliersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supplier" do
    assert_difference('Supplier.count') do
      post suppliers_url, params: { supplier: { name: @supplier.name, phone: @supplier.phone, user_id: @supplier.user_id } }
    end
  ...
  test "should update supplier" do
    patch supplier_url(@supplier), params: { supplier: { name: @supplier.name, phone: @supplier.phone, user_id: @supplier.user_id } }
